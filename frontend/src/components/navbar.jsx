                ...
                {user ? (
                    <>
                        <button 
                            ...
                            className='flex flex-col items-center gap-1 cursor-pointer hover:text-green-600 transition-colors'
                        >
                            <p>History</p>
                        </button>
                        <button 
                            className='flex flex-col items-center gap-1 cursor-pointer hover:text-red-600 transition-colors' 
                    ...
                    <NavLink to='/login' className='flex flex-col items-center gap-1'>
                        <p className="bg-green-600 text-white px-4 py-1 rounded-md hover:bg-green-700 transition-colors">
                            Login
                        </p>
                    </NavLink>
                )}
